...
public class TestFinance {
	...
	public void TestPMT() {
		...
		double dRequiredIncome = 10000;
		double dMonthlySSI = 2642;
		//just used same numbers as above here, but got a bit confused as i thought 
		//the return was already a percent, so is 0.07 = 0.07% not 7% ?

		//TODO: Test PMT.  Make sure PMT works as expected.
		
		double PV = Retirement.PV(dAnnualReturnRetired / 12, iYearsRetired * 12, dRequiredIncome - dMonthlySSI, 0, false);
		//took this line from above as it's simpler for PMT this way
